...
public class MainActivity extends AppCompatActivity
    ...
    private ArrayList<String> favourits = new ArrayList<>();
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.exhibitions_list) {
            ...
            fragment = new MuseumHistoryFragment();
        }else if (id == R.id.favoutites){

            fragment = new FavouritesFragment();
            Bundle bundle = new Bundle();
            bundle.putString("arg1", "Mona Lisa");
            bundle.putString("arg2", "The Last Supper");
